    ...
    <form action="<?php echo $this->url ?>" method="get" class="search-form">
        ...
        <div class="row">
            <div class="col-md-3">
                ...
                <input type="text" name="char_id" id="char_id" class="form-control" value="<?php echo htmlspecialchars($params->get('char_id') ?: '') ?>" />
            </div>
            <div class="col-md-3">
                <label for="account">Account:</label>
                <input type="text" name="account" id="account" class="form-control" value="<?php echo htmlspecialchars($params->get('account') ?: '') ?>" />
            </div>
            <div class="col-md-3">
        ...
        <div class="row">
            <div class="col-md-3">
                ...
                <select name="base_level_op" class="form-select">
                ...
                <input type="text" name="base_level" id="base_level" class="form-control" value="<?php echo htmlspecialchars($params->get('base_level') ?: '') ?>" />
            </div>
            <div class="col-md-3">
                <label for="job_level">Job Level:</label>
                <select name="job_level_op" class="form-select">
                ...
                <input type="text" name="job_level" id="job_level" class="form-control" value="<?php echo htmlspecialchars($params->get('job_level') ?: '') ?>" />
            </div>
            <div class="col-md-3">
                <label for="zeny">Zeny:</label>
                <select name="zeny_op" class="form-select">
                ...
                <input type="text" name="zeny" id="zeny" class="form-control" value="<?php echo htmlspecialchars($params->get('zeny') ?: '') ?>" />
            </div>
            <div class="col-md-3">
                <label for="guild">Guild:</label>
                <input type="text" name="guild" id="guild" class="form-control" value="<?php echo htmlspecialchars($params->get('guild') ?: '') ?>" />
            </div>
        </div>
        <div class="row">
            <div class="col-md-3">
                <label for="partner">Partner:</label>
                <input type="text" name="partner" id="partner" class="form-control" value="<?php echo htmlspecialchars($params->get('partner') ?: '') ?>" />
            </div>
            <div class="col-md-3">
                <label for="mother">Mother:</label>
                <input type="text" name="mother" id="mother" class="form-control" value="<?php echo htmlspecialchars($params->get('mother') ?: '') ?>" />
            </div>
            <div class="col-md-3">
                <label for="father">Father:</label>
                <input type="text" name="father" id="father" class="form-control" value="<?php echo htmlspecialchars($params->get('father') ?: '') ?>" />
            </div>
            <div class="col-md-3">
                <label for="child">Child:</label>
                <input type="text" name="child" id="child" class="form-control" value="<?php echo htmlspecialchars($params->get('child') ?: '') ?>" />
            </div>
        </div>
        <div class="row">
            <div class="col-md-3">
            ...
            <div class="col-md-3">
                ...
                <select name="slot_op" class="form-select">
                ...
                <input type="text" name="slot" id="slot" class="form-control" value="<?php echo htmlspecialchars($params->get('slot') ?: '') ?>" />
            </div>
        </div>
        <div class="row">
            <div class="col-md-3">
                <input type="submit" value="Search" class="btn btn-primary" />
                <input type="button" value="Reset" class="btn btn-secondary" onclick="reload()" />
            </div>
        </div>
    </form>
    <?php if ($characters): ?>
